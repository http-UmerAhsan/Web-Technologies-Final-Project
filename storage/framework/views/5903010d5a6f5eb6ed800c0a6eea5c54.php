<?php $__env->startSection('title','Contact Us — Nike Pakistan'); ?>
...
<div class="contact-page">
  ...
  <div class="contact-body">
    ...
    <div class="contact-form-panel">
      ...
      <div style="background:#d4edda;border:1px solid #b8ddb8;padding:16px;margin-bottom:24px;font-size:14px;color:#1a5a1a;display:flex;align-items:center;gap:10px"><i class="fa fa-circle-check"></i> <?php echo e(session('success')); ?></div>
      <?php endif; ?>
      <form method="POST" action="<?php echo e(route('contact.send')); ?>" novalidate>
        <?php echo csrf_field(); ?>
        <div class="form-grid-2">
          <div class="form-field"><label>First Name <span class="req">*</span></label><input type="text" name="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="Ahmad" class="<?php echo e($errors->has('first_name')?'is-error':''); ?>"><div class="field-error"><?php echo e($errors->first('first_name')); ?></div></div>
          <div class="form-field"><label>Last Name <span class="req">*</span></label><input type="text" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="Khan" class="<?php echo e($errors->has('last_name')?'is-error':''); ?>"><div class="field-error"><?php echo e($errors->first('last_name')); ?></div></div>
        </div>
        ...
        <div class="form-field"><label>Subject</label>
          <select name="subject">
            <?php $__currentLoopData = ['Order Inquiry','Product Question','Returns & Exchanges','Technical Support','Partnership','Other']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($s); ?>" <?php echo e(old('subject')==$s?'selected':''); ?>><?php echo e($s); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
        <div class="form-field"><label>Message <span class="req">*</span></label><textarea name="message" placeholder="Tell us how we can help..." class="<?php echo e($errors->has('message')?'is-error':''); ?>"><?php echo e(old('message')); ?></textarea><div class="field-error"><?php echo e($errors->first('message')); ?></div></div>
