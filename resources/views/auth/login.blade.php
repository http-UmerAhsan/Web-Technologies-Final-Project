...
<div class="login-page">
  ...
  <div class="login-right">
    <div class="login-form-wrap">
      ...
      <div class="login-error"><i class="fa fa-triangle-exclamation"></i><span>{{ $errors->first('general') }}</span></div>
      @endif
      @if(session('success'))
      <div class="login-error" style="background:#f0fdf4;border-color:#86efac;border-left-color:#16a34a;color:#15803d"><i class="fa fa-circle-check"></i><span>{{ session('success') }}</span></div>
      @endif
      <form method="POST" action="{{ route('admin.login.post') }}" novalidate>
        ...
        <div class="form-field">
          ...
          <div class="input-wrap">
            ...
            <input type="text" name="username" value="{{ old('username') }}" placeholder="Enter your username" class="{{ $errors->has('username')?'is-error':'' }}" autocomplete="username">
          </div>
        ...
        <div class="form-field">
          ...
          <div class="input-wrap">
            ...
            <input type="password" name="password" id="pw-input" placeholder="Enter your password" class="{{ $errors->has('password')?'is-error':'' }}" autocomplete="current-password">
      ...
      <a href="{{ route('home') }}" class="btn-back-store"><i class="fa fa-arrow-left"></i> Back to Store</a>
